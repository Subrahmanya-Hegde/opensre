...
<Note>Coming from Tracer? Welcome. OpenSRE is the open-source home for these docs, while some live URLs, installers, assets, and Slack app labels still use the Tracer name during the transition.</Note>
...
<Frame>
  <div style={{ position: 'relative', width: '100%' }}>
    <img
      src="/images/how-it-works-bg-v2.webp"
      alt=""
      style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', zIndex: 0 }}
    />
    <div
      style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', backgroundImage: 'url(/images/pattern/bg-grid.svg)', backgroundRepeat: 'repeat', backgroundSize: 'auto', zIndex: 1, opacity: 0.5 }}
    />
    <img
      src="/images/how_tracer_works.png"
      alt="How OpenSRE Works"
      style={{ position: 'relative', zIndex: 2, width: '100%', height: 'auto', display: 'block', margin: '0 auto', padding: '1.5rem' }}
    />
  </div>
</Frame>